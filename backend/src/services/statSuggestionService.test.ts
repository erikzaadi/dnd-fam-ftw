...
if (out1.might !== 5) throw new Error(`Expected might 5, got ${out1.might}`);
if (out1.magic !== 1) throw new Error(`Expected magic 1, got ${out1.magic}`);
if (out1.mischief !== 1) throw new Error(`Expected mischief 1, got ${out1.mischief}`);
...
if (out2.magic !== 5) throw new Error(`Expected magic 5, got ${out2.magic}`);
if (out2.might !== 1) throw new Error(`Expected might 1, got ${out2.might}`);
...
if (out3.mischief !== 5) throw new Error(`Expected mischief 5, got ${out3.mischief}`);
if (out3.might !== 1) throw new Error(`Expected might 1, got ${out3.might}`);
...
if (out4.might !== 3) throw new Error(`Expected might 3 (rounded from 2.7), got ${out4.might}`);
if (out4.magic !== 1) throw new Error(`Expected magic 1 (rounded from 1.2), got ${out4.magic}`);
if (out4.mischief !== 4) throw new Error(`Expected mischief 4 (rounded from 3.5), got ${out4.mischief}`);
...
if (out5.might !== 5) throw new Error(`Expected might clamped to 5, got ${out5.might}`);
...
if (out6.might !== 1) throw new Error(`Expected might clamped to 1, got ${out6.might}`);
if (out6.magic !== 1) throw new Error(`Expected magic clamped to 1, got ${out6.magic}`);
...
if (out7.might !== STAT_FALLBACK.might) throw new Error(`Expected fallback might ${STAT_FALLBACK.might}, got ${out7.might}`);
if (out7.magic !== STAT_FALLBACK.magic) throw new Error(`Expected fallback magic ${STAT_FALLBACK.magic}, got ${out7.magic}`);
if (out7.mischief !== STAT_FALLBACK.mischief) throw new Error(`Expected fallback mischief ${STAT_FALLBACK.mischief}, got ${out7.mischief}`);
...
if (out8.might !== STAT_FALLBACK.might) throw new Error(`Expected fallback, got ${JSON.stringify(out8)}`);
...
if (out9.might !== STAT_FALLBACK.might) throw new Error(`Expected fallback, got ${JSON.stringify(out9)}`);
...
if (out10.might !== 4) throw new Error(`Expected might 4, got ${out10.might}`);
if (out10.magic !== STAT_FALLBACK.magic) throw new Error(`Expected magic fallback ${STAT_FALLBACK.magic}, got ${out10.magic}`);
if (out10.mischief !== STAT_FALLBACK.mischief) throw new Error(`Expected mischief fallback ${STAT_FALLBACK.mischief}, got ${out10.mischief}`);
...
if (out11.might !== 3) throw new Error(`Expected might 3, got ${out11.might}`);
if (out11.magic !== 2) throw new Error(`Expected magic 2, got ${out11.magic}`);
...
if (out12.mischief !== 4) throw new Error(`Expected mischief 4, got ${out12.mischief}`);
if (out12.magic !== 1) throw new Error(`Expected magic 1, got ${out12.magic}`);
