...
export class ImageService {
    static PUBLIC_DIR = path.join(__dirname, '..', '..', 'public', 'images');
    static DEFAULT_IMAGE = '/api/images/default_scene.png';
    static async generateAvatar(char, sessionId) {
    ...
    static async generateImage(prompt, sessionId, sceneId) {
        const promptHash = crypto.createHash('md5').update(prompt).digest('hex');
